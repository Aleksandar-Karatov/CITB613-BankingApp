        ...
        public static void Initialize(BankingDbContext context)
        {
            ...
            var products = new BankProduct[]
            {
                ...
                new BankProduct
                {
                    ...
                    Description = "Депозит в лева с ежемесечно изплащане на лихвата по разплащателна сметка.",
                    Currency = "EUR",
                    TermMonths = 12,
                    InterestRate = 1.95m,
                    MinAmount = 5000m,
                ...
                new BankProduct
                {
                    ...
                    Description = "Гъвкав 6-месечен депозит в лева с възможност за допълване и капитализиране.",
                    Currency = "EUR",
                    TermMonths = 6,
                    InterestRate = 1.20m,
                    MinAmount = 1000m,
